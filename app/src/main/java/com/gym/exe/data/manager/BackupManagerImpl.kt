...
import com.gym.exe.data.model.BackupData
...
class BackupManagerImpl(
    ...
    override suspend fun createBackup(folderUri: Uri): Result<String> = withContext(Dispatchers.IO) {
        try {
            // 1. Fetch Data
    ...
    override suspend fun restoreBackup(fileUri: Uri): Result<Unit> = withContext(Dispatchers.IO) {
        try {
